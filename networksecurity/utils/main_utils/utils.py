...
def save_object(file_path: str,obj: object)->None:
    ...
    Returns: None
    Raises:
        NetworkSecurityException: If there is an error saving the object to the file.
    """
    try:
...
def load_object(file_path: str)->object:
    ...
    Raises:
        NetworkSecurityException: If there is an error loading the object from the file.    
    """
    try:
